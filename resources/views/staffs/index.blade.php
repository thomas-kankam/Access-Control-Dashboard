            ...
            <div class="col-12 d-flex align-items-center justify-content-between py-3 mb-4">
                <div>
                    <h4 class="m-0">
                        ...
                        <span class="text-primary" style="font-size: 18px; font-weight: bold;">Staffs</span>
                    </h4>
                </div>
                <div class="d-flex gap-3 align-items-center">
                    <button class="btn btn-primary d-flex align-items-center justify-content-center" type="button"
                        ...
                        <span class="d-sm-none d-none d-lg-inline">Add Staff</span>
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <div class="text-center mb-4">
                        <h3 class="address-title">Add new staff</h3>
                        <p class="address-subtitle">
                            Type in the new staff data and click proceed to add to database
                        </p>
                    </div>
                    <form id="addNewAddressForm" class="row g-3" method="POST" action="{{ route('save.staff') }}">
                        @csrf
                        <div class="col-12">
                            <div class="row">
                                <div class="mb-3">
